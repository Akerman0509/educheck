...
export default function SchoolPage() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      ...
      {successMsg && (
        <div className="text-green-600 mb-4 text-sm whitespace-pre-wrap">{successMsg}</div>
      )}
      ...
      <div className="flex flex-row gap-10 mt-5">
        ...
        <div className="flex flex-col gap-3">
          <InputField
            ...
            onChange={(value) => handleInputChange("studentAddress", value)}
          />
          <InputField
          ...
          <InputField
            ...
            onChange={(value) => handleInputChange("nganhDT", value)}
          />
        </div>
        ...
        <div className="flex flex-col">
          ...
          {filePDF && (
            <p className="text-sm text-green-600 mt-2">✓ {filePDF.name}</p>
          )}
        </div>
      </div>
